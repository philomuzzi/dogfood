...
class GamePlayer;
typedef bool(*ClientMsgCallback)(std::shared_ptr<GamePlayer> player, const void *msg, const short msglen);
...
public:
	~ClientMsgCenter() = default;
	bool registry();
	bool dispatch(short msgid, std::shared_ptr<GamePlayer> player, const void *msg, const short msglen) {
